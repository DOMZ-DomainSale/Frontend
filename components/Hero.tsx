...
const Hero = () => {
    return (
        <>
            <div className="mx-auto flex flex-col items-center py-12 sm:py-24 pt-12 ">
                <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
                    <h1
                        ...
                        Your Domain Search Starts at DOMZ
                    ...
                    <p className="mt-5 sm:mt-10 lg:w-10/12 text-gray-600 dark:text-gray-300 font-normal text-center text-xl">
                        Browse a comission-free catalog and connect directly with the domain owners.
                    </p>
                </div>
                <div className="flex w-11/12 md:w-8/12 xl:w-6/12">
                    <div className="flex rounded-md w-full">
                        <input
                            type="text"
                            name="q"
                            className="w-full p-3 rounded-md rounded-r-none border-2 border-gray-300 placeholder-current placeholder-opacity-100"
                            placeholder='search'
                        />
                        <button
                            className="inline-flex items-center gap-2 bg-violet-700 text-white text-lg  py-3 px-6 rounded-r-md"
                        >
